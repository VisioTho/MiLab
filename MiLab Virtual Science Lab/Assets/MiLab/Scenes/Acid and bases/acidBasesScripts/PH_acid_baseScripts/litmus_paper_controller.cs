...
public class litmus_paper_controller : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (litmus_paper_toggler.isOn) {currentLitmusColor = "red";}else{currentLitmusColor = "blue";}
        ...
        if (gOtag == "hydrochloric_acid" || gOtag == "ethanoic_acid" || gOtag == "vinegar" || gOtag == "milk" || gOtag == "tomato")//ACIDS
        {
            ...
            if (currentLitmusColor == "blue")
            {
                if (lastDippedInto != gOtag)
                {
                    ...
                    if (gOtag == "vinegar" || gOtag == "milk" || gOtag == "tomato")
                    {
                        StartCoroutine(changeLitmusColor(litmus_paper_b, new Color32(247, 82, 36, 255)));
                    }
                }
                ...
                {
                    litmus_paper_b.GetComponent<SpriteRenderer>().color = new Color32(161, 80, 63, 255);

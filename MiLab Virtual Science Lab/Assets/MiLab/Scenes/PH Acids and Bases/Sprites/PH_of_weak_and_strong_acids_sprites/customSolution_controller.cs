...
public class customSolution_controller : MonoBehaviour
{
    ...
    public GameObject hydrochloric_acid_beaker, sodium_hydroxide_beaker, ammonium_solution_beaker, pippete, litmus_paper, ethanoic_acid_beaker, ethanoic_acid_label;
